...
internal sealed class DamageMeterPlayerWidget
{
	...
	public void Draw(ImDrawListPtr drawList, Vector2 position)
	{
		...
		this._nameLabelElement.Draw(drawList, position, 1f, this._damageMeterEntity.Name, this._damageMeterEntity.Id, this._damageMeterEntity.HunterRank,
			this._damageMeterEntity.MasterRank);
	}
}